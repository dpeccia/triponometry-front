        ...
        <>
            <Modal size='lg' isCentered isOpen={props.isOpen} onClose={props.onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <Heading fontSize='md'>
                            ¿Descargaste el mapa y no sabés que hacer? Podés importarlo fácilmente en Google My Maps
                        </Heading>
                        <Text mt='3' mx='5'>
                            1) Entrá a 
                        ...
                        <Text mt='2' mx='5'>3) Creá un nuevo mapa</Text>
                        <Text mt='2' mx='5'>4) Hacé click en "Importar" y arrastrá el archivo .kml que descargaste de Triponometry</Text>
